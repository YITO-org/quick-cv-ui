...
let ResumeSix : React.FC<any> = (props)=>{
...
let Heading : React.FC<any> = (props)=>{
    ...
    return(
        <div className={`fw-bold mt-3  text-center text-uppercase heading_font p-2`}>
            <div className={`w-100 mb-2`} style={{ height : "4px" , backgroundColor : '#232e2e' }} ></div>
            <div className={`w-100`} style={{ height : "3px" , backgroundColor : '#232e2e' }} ></div>
...
export default connect(mapStateToProps, (dispatch:any) => ({ dispatch }))(ResumeSix);
